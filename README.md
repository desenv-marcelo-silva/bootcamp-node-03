# bootcamp-node-03
Third challenge of RocketSeat Bootcamp #10 - FastFeet part II.
...
<p align="center">
  ...
  <a href="https://rocketseat.com.br">
    <img alt="Proposed by Rocketseat" src="https://img.shields.io/badge/made%20by-Rocketseat-%2304D361">
  </a>
...
Durante esse desafio a aplicação FastFeet que foi feita no desafio anterior será melhorada, implementando funcionalidades que foram aprendidas durante as aulas até agora.
...
Criaço de rotas para listagem/cadastro/atualização/remoção de entregadores;

Obs.: Apenas para administradores autenticados na aplicação.

### **2. Gestão de encomendas**

Mesmo o entregador estando cadastrado, ele não é independente dentro da plataforma e encomendas devem ser cadastradas para os entregadores.

Nessa funcionalidade um cadastro de encomendas por entregador foi criado. A encomenda possui os campos:
...
Rotas para listagem/cadastro/atualização/remoção de encomendas foram criadas;
...
Permitir também que ele liste apenas as encomendas que já foram **entregues** por ele, com base em seu ID de cadastro;

Exemplo de requisição: `GET https://fastfeet.com/deliveryman/1/deliveries`

### 2. Alterar status de encomendas

Deve permitir que o entregador tenha rotas para incluir uma data de retirada (start_date) e data de entrega (end_date) para as encomendas. O entregador só pode fazer **5 retiradas por dia**.

Obs.: Para a funcionalidade de finalizar a entrega, deve-se permitir o envio de uma imagem que irá preencher o campo signature_id da tabela de encomendas.
...
A tabela `delivery_problems` deve contém os seguintes campos:
...
Criada uma rota para a distribuidora listar todas as entregas com algum problema;

Criada uma rota para listar todos os problemas de uma encomenda baseado no ID da encomenda.

Exemplo de requisição: `GET https://fastfeet.com/delivery/2/problems`

Criar uma rota para o entregador cadastrar problemas na entrega apenas informando seu ID de cadastro (ID da encomenda no banco de dados);

Exemplo de requisição: `POST https://fastfeet.com/delivery/3/problems`

Criar uma rota para a distribuidora cancelar uma entrega baseado no ID do problema. Esse cancelamento pode acontecer devido a gravidade do problema da entrega, por exemplo, em caso de perda da encomenda.
...
Proposto com ♥ by Rocketseat 👋 [Entre na nessa comunidade!](https://discordapp.com/invite/gCRAFhc)
